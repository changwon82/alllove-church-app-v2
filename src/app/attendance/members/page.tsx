...
export default function AttendanceMembersPage() {
  ...
  }, [loading, hasPermission, selectedDepartment]);
    ...
    <div>
      ...
      {showAddForm && (
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
            ...
            <div>
              ...
              <select
                ...
                style={{
                  width: "100%",
                  padding: "8px 10px",
                  paddingRight: isMobile && !isAdmin && userDepartment ? "40px" : "10px",
                  borderRadius: 6,
                  border: "1px solid #e5e7eb",
                  fontSize: 13,
                  ...
                  MozAppearance: "none",
                  appearance: "none",
                  backgroundImage: isMobile && !isAdmin && userDepartment
                  ...
                  backgroundPosition: isMobile && !isAdmin && userDepartment ? "right 12px center" : "right center",
                  backgroundSize: "12px",
                }}
              >
            ...
            {!(isMobile && !isAdmin && userDepartment) && (
            <div>
              <label style={{ fontSize: 12, fontWeight: 500, color: "#374151", display: "block", marginBottom: 6 }}>
                부서
              </label>
      ...
      <div
        style={{
          ...
          width: isMobile ? "100%" : ((isAdmin || userDepartment) ? "800px" : "auto"),
          maxWidth: "100%",
        }}
      >
        <div style={{ overflowX: isMobile ? "visible" : ((isAdmin || userDepartment) ? "visible" : "auto"), width: "100%" }}>
          <table style={{ width: isMobile ? "100%" : ((isAdmin || userDepartment) ? "800px" : "auto"), borderCollapse: "collapse", fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13), tableLayout: isMobile ? "fixed" : ((isAdmin || userDepartment) ? "fixed" : "auto") }}>
            <thead>
              <tr style={{ backgroundColor: "#f9fafb" }}>
                <th
                  style={{
                    padding: (isAdmin || userDepartment) ? "6px 2px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "3px 1px" : "2px 1px") : "6px"),
                    textAlign: "center",
                    fontWeight: 600,
                    color: "#374151",
                    borderBottom: "1px solid #e5e7eb",
                    whiteSpace: "nowrap",
                    width: isMobile ? "7%" : ((isAdmin || userDepartment) ? "32px" : "auto"),
                    fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13),
                  }}
                >
                  {!(isMobile && !isAdmin && userDepartment) ? "번호" : ""}
                </th>
                {!(isMobile && !isAdmin && userDepartment) && (
                <th
                  style={{
                ...
                <th
                  style={{
                    ...
                    borderBottom: "1px solid #e5e7eb",
                    whiteSpace: "nowrap",
                    width: isMobile ? (isMobile && !isAdmin && userDepartment ? "30%" : "25%") : "auto",
                    fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13),
                  }}
                >
                  이름
                ...
                <th
                  style={{
                    ...
                    borderBottom: "1px solid #e5e7eb",
                    whiteSpace: "nowrap",
                    width: isMobile ? (isMobile && !isAdmin && userDepartment ? "30%" : "26%") : "auto",
                    fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13),
                  }}
                >
                  생년월일
                ...
                <th
                  style={{
                    ...
                    borderBottom: "1px solid #e5e7eb",
                    whiteSpace: "nowrap",
                    width: isMobile ? (isMobile && !isAdmin && userDepartment ? "40%" : "30%") : "auto",
                    fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13),
                  }}
                >
                  {!isDeleteMode && (
                    <div style={{ display: "flex", gap: isMobile ? 2 : 4, alignItems: "center", justifyContent: (isMobile && !isAdmin && userDepartment) ? "flex-end" : "center", whiteSpace: "nowrap" }}>
                      <button
                        ...
                        style={{
                          ...
                          height: isMobile ? ((isMobile && !isAdmin && userDepartment) ? "21px" : "24px") : "28px",
                          minWidth: isMobile ? "24px" : "28px",
                          minHeight: isMobile ? ((isMobile && !isAdmin && userDepartment) ? "21px" : "24px") : "28px",
                      ...
                      {!isAdmin && userDepartment && (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: 4,
                            border: "1px solid #e5e7eb",
                            background: isEditMode ? "#3b82f6" : "#ffffff",
                  ...
                  {isDeleteMode && (
                    <div style={{ display: "flex", gap: isMobile ? 2 : 4, alignItems: "center", justifyContent: "center", whiteSpace: "nowrap" }}>
                      {members.length > 0 && (
                        <input
                          type="checkbox"
            ...
            <tbody>
              ...
              {pendingMembers.map((pending, idx) => (
                <tr key={pending.id} style={{ borderBottom: "1px solid #e5e7eb", backgroundColor: "#fef3c7" }}>
                  <td style={{ padding: (isAdmin || userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", color: "#6b7280", fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                    {members.length + idx + 1}
                  </td>
                  {!(isMobile && !isAdmin && userDepartment) ? (
                  <td style={{ padding: (!isAdmin && userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", whiteSpace: "nowrap", verticalAlign: "middle" }}>
                    <select
                      value={pending.department}
                      onChange={(e) => handlePendingFieldChange(pending.id, "department", e.target.value)}
                      style={{
                        padding: (isMobile && !isAdmin && userDepartment) ? "4px 5px" : ((isAdmin || userDepartment) ? "6px 8px" : (isMobile ? "1px 2px" : "4px 6px")),
                        borderRadius: 4,
                        border: "1px solid #d1d5db",
                        fontSize: (isMobile && !isAdmin && userDepartment) ? 8 : ((isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 12)),
                        width: "100%",
                        minWidth: (isMobile && !isAdmin && userDepartment) ? "30px" : (isMobile ? "50px" : "80px"),
                      }}
                    >
                      <option value="">선택 안 함</option>
                  ...
                  <td style={{ padding: (isAdmin || userDepartment) ? "14px 6px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "left", whiteSpace: "nowrap", verticalAlign: "middle" }}>
                    <div style={{ display: "flex", gap: (isMobile && !isAdmin && userDepartment) ? 4 : (isMobile ? 1 : 4), alignItems: "center", justifyContent: "flex-start", flexWrap: "nowrap" }}>
                      <input
                        type="text"
                        value={pending.name}
                        ...
                        border: "1px solid #d1d5db",
                        fontSize: (isMobile && !isAdmin && userDepartment) ? 8 : ((isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 12)),
                        width: (isMobile && !isAdmin && userDepartment) ? "80px" : (isMobile ? "50px" : "80px"),
                        minWidth: (isMobile && !isAdmin && userDepartment) ? "64px" : (isMobile ? "40px" : "80px"),
                        }}
                      />
                      <select
                        ...
                        style={{
                        padding: (isMobile && !isAdmin && userDepartment) ? "4px 8px 4px 5px" : ((!isAdmin && userDepartment) ? "6px 8px" : (isMobile ? "1px 2px" : "4px 6px")),
                        borderRadius: 4,
                        border: "1px solid #d1d5db",
                        fontSize: (isMobile && !isAdmin && userDepartment) ? 8 : ((!isAdmin && userDepartment) ? 13 : (isMobile ? 9 : 12)),
                        width: (isMobile && !isAdmin && userDepartment) ? "80px" : (isMobile ? "35px" : "50px"),
                        minWidth: (isMobile && !isAdmin && userDepartment) ? "72px" : (isMobile ? "30px" : "50px"),
                        }}
                      >
                        <option value="">-</option>
                        <option value="남">남</option>
                  ...
                  <td style={{ padding: (isAdmin || userDepartment) ? "14px 6px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "left", whiteSpace: "nowrap", verticalAlign: "middle" }}>
                    <div style={{ position: "relative", display: "inline-block", marginLeft: (isMobile && !isAdmin && userDepartment) ? "8px" : "0" }}>
                      <input
                        type="date"
                        ...
                        style={{
                          ...
                          border: "1px solid #d1d5db",
                          fontSize: (isMobile && !isAdmin && userDepartment) ? 8 : ((isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 12)),
                          width: (isMobile && !isAdmin && userDepartment) ? "32px" : (isMobile ? "100%" : "auto"),
                          color: (isMobile && !isAdmin && userDepartment) ? "transparent" : "inherit",
                          cursor: "pointer",
                        }}
                      />
                      {(isMobile && !isAdmin && userDepartment) && (
                  ...
                  <td style={{ padding: (isAdmin || userDepartment) ? "12px 6px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", whiteSpace: "nowrap", verticalAlign: "middle" }}>
                    <div style={{ display: "flex", gap: isMobile ? 2 : 4, justifyContent: (isMobile && !isAdmin && userDepartment) ? "flex-end" : "center", alignItems: "center", whiteSpace: "nowrap" }}>
                      <button
                        onClick={() => {
                      ...
                      {idx === pendingMembers.length - 1 && (
                        <button
                          ...
                          style={{
                            ...
                            height: isMobile ? ((!isAdmin && userDepartment) ? "21px" : "auto") : "auto",
                            minHeight: isMobile ? ((!isAdmin && userDepartment) ? "21px" : "24px") : "auto",
                          }}
                        >
              ...
              {members.length === 0 && pendingMembers.length === 0 ? (
                <tr>
                  <td
                    colSpan={!(isMobile && !isAdmin && userDepartment) ? 5 : 4}
                    style={{
                      padding: "40px",
                      textAlign: "center",
                      color: "#9ca3af",
                ...
                members.map((member, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!(isMobile && !isAdmin && userDepartment) && (
                      <td style={{ padding: (!isAdmin && userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", color: "#374151", fontSize: (!isAdmin && userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                        {displayDepartment || "-"}
                      </td>
                      )}
                      <td style={{ padding: (isAdmin || userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "left", fontWeight: 500, color: "#1f2937", fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                        {isMobile && !isAdmin && userDepartment ? (
                          <span>
                            {member.name}
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            ...
                            {isEditMode && !isAdmin && userDepartment && (
                              <button
                      ...
                      <td style={{ padding: (isAdmin || userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "left", color: "#374151", fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          <span>
                            {member.birth_date ? new Date(member.birth_date).toLocaleDateString("ko-KR") : "-"}
                          </span>
                          {isEditMode && isMobile && !isAdmin && userDepartment && (
                            <button
                              onClick={() => handleEdit(member)}
                              style={{
                                padding: "2px 6px",
                ...
                <>
                  <tr>
                    ...
                    >
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div style={{ fontSize: isMobile ? 9 : 12, fontWeight: 600, color: "#6b7280" }}>
                          제적 처리된 멤버
                        </div>
                      </div>
                    </td>
                  ...
                  {inactiveMembers.map((member, index) => {
                    ...
                    return (
                      ...
                      >
                        <td style={{ padding: (!isAdmin && userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", color: "#9ca3af", fontSize: (!isAdmin && userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                          {inactiveNumber}
                        </td>
                        {!(isMobile && !isAdmin && userDepartment) && (
                        <td style={{ padding: (!isAdmin && userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", color: "#9ca3af", fontSize: (!isAdmin && userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                        ...
                        <td style={{ padding: (isAdmin || userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "left", fontWeight: 500, color: "#6b7280", fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                          {member.name}
                          {member.gender || age !== null ? ` (${member.gender || "?"}/${age !== null ? age : "?"})` : ""}
                        </td>
                        <td style={{ padding: (isAdmin || userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "left", color: "#9ca3af", fontSize: (isAdmin || userDepartment) ? 13 : (isMobile ? 9 : 13), whiteSpace: "nowrap", verticalAlign: "middle" }}>
                        {member.birth_date ? new Date(member.birth_date).toLocaleDateString("ko-KR") : "-"}
                      </td>
                        <td style={{ padding: (!isAdmin && userDepartment) ? "6px 3px" : (isMobile ? ((isMobile && !isAdmin && userDepartment) ? "2px 1px" : "1px 1px") : "6px"), textAlign: "center", whiteSpace: "nowrap", verticalAlign: "middle" }}>
                          ...
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: 4,
                                ...
                                height: isMobile ? ((isMobile && !isAdmin && userDepartment) ? "21px" : "auto") : "auto",
